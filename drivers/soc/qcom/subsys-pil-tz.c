...
// add for fix gssi build error zzw 20200529
#ifdef CONFIG_SUPPORT_CRASH_REASON
// store subsystem fail reason to RESET LOG buffer zzw 20200528
...
// add for fix gssi build error zzw 20200529
#ifdef CONFIG_SUPPORT_CRASH_REASON        
	// store subsys fault reason to share RESET LOG  zzw 20200528
