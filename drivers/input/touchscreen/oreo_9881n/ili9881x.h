...
struct ilitek_ts_data {
	...
	struct delayed_work ili_work;
//HMD ling.yi add for TP resume start
#if defined(CONFIG_FB) || defined(CONFIG_DRM)
	struct work_struct resume_work;
#endif
//HMD ling.yi add for TP resume end
};
...
extern int ili_ic_watch_dog_ctrl(bool write, bool enable);
...
extern int ili_set_tp_data_len(int format, bool send);
...
extern void ili_report_handler(void);
...
extern void ili_tp_power_off(void);
